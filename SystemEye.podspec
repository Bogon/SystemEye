...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = 'SystemEye is a system monitor,automatic catch the infomation of cpu,memory,fps,netflow....etc.. 支持swift最低版本4.0，支持iOS最低版本10.0'

  s.homepage         = 'https://github.com/Bogon/SystemEye'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Bogon' => 'zhangqixcu@gmail.com' }
  s.source           = { :git => 'https://github.com/Bogon/SystemEye.git', :tag => s.version.to_s }
